...
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'] . "/ci-company/",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_base_path' => '../files/editor-thumb/',
    ...
    |
    */
    'thumbs_upload_dir' => '/files/editor-thumb/',
    ...
    */
    ...
    'access_keys' => array('DionisiusLumrangGesangie'),
