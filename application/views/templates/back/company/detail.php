                ...
                <?php echo form_open_multipart('admin/company/update', ['method' => 'post', 'id' => 'formData', 'autocomplete' => 'off']); ?>
                    ...
                    <div class="row" id="previewAttachment">
                        <div class="form-group col-md-4 item py-1">
                            ...
                            <div class="border">
                                <img src="<?php echo checkRemoteFile(base_url('files/company/thumb/'.$company['logo'])) ? base_url('files/company/thumb/'.$company['logo']) : base_url('assets/img/default-picture.jpg'); ?>" alt="Atacchment Preview" class="img-fluid">
                                <div class="layer">
                                    <button type="button" class="btn btn-sm btn-outline-primary rounded-0 venobox" <?php echo checkRemoteFile(base_url('files/company/'.$company['logo'])) ? 'data-href="' . base_url('files/company/'.$company['logo']) .'"' : 'hidden'; ?>>View</button>
