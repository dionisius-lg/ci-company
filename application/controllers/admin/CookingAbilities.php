...
class CookingAbilities extends CI_Controller {
    function __construct()
    {
        ...
        $this->template->title = 'Cooking Abilities';
    ...
    public function index()
    {
        ...
        $request = [
            'cooking_abilities' => $this->CookingAbilitiesModel->getAll($clause)
        ];
        ...
        $this->result['pagination'] = bs4pagination('admin/cooking-abilities', $total, $clause['limit'], $params);
        $this->result['no'] = (($clause['page'] * $clause['limit']) - $clause['limit']) + 1;
        
        $this->template->content->view('templates/back/CookingAbilities/index', $this->result);
    ...
    public function detail($id)
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $request = $this->CookingAbilitiesModel->getDetail($id);
    ...
    public function create()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $request = $this->CookingAbilitiesModel->insert($data);
    ...
    public function update($id)
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $request = $this->CookingAbilitiesModel->update($data, $id);
    ...
    public function delete($id = null)
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $request = $this->CookingAbilitiesModel->delete($id);
    ...
    private function validate($file = false, $id = 0)
    {
        $validate = [
            [
                'field' => 'name',
                'label' => 'Name',
                'rules' => 'trim|required|max_length[100]|regexAlphaSpace|checkCookingAbilitiesName['.$id.']|xss_clean'
            ],
